...
**AWS Management Console** cung cấp giao diện web đơn giản cho người dùng sử dụng AWS
...
5. [Khám phá và cấu hình AWS Management Console](5-explore-and-configure-the-aws-management-console/)
